...
const uint8_t fingerprint[20] = {0x57, 0xC9, 0xD7, 0x30, 0xFA, 0xE9, 0xE9, 0x13, 0x3D, 0x72, 0x38, 0xF5, 0x2B, 0x48, 0xEF, 0xEB, 0x49, 0x09, 0x65, 0x09};

String registerUrl = "https://dz40eacaqk.execute-api.us-east-1.amazonaws.com/dev/robot/register";
// Define Servo
Servo servo; 
